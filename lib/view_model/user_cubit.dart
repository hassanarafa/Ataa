...
////================ --- data =========================/////
  ...
  userLogin(context, {required email, required password}) {
    String adminEmail = "Hassan1212@Rms.com";
    String adminPassword = "HA123456";

    String UserEmail = "Hassan1212@Rms.com";
    String UserPassword = "HA123456";

    String ownerEmail = "Hassan1212@Rms.com";
    String ownerPassword = "HA123456";
//isUser
//isAdmin
//isOwner
